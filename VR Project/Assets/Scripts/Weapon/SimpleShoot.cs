...
public class SimpleShoot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        socketInteractor.onSelectEntered.AddListener(LoadMagazine);
    ...
    {
        Debug.Log("shoot");
        gunAudio.PlayOneShot(gunFireSound);
        magazine.numOfAmmo--;
    ...
    {
        if (magazine && magazine.numOfAmmo > 0 && hasSlide)
        {
            gunAnimator.SetTrigger("Fire");
        }
        else
        {
            gunAudio.PlayOneShot(noAmmoSound);
        }

    }

    public void LoadMagazine(XRBaseInteractable interactable)
    {
