...
public class HandPresence : MonoBehaviour
{
    ...
    private void TryInitialize()
    {
        ...
        if (devices.Count > 0)
        {
            ...
            GameObject controller = controllerPrefabs.Find(ctrl => ctrl.name == targetDevice.name); // ��� ����Ʈ ���鼭 controller.name�ϰ� targerDevice.name�ϰ� ��Ī�غ��� ������ return ������ �����ش�.
        ...
        {
            // spawn the hand
            spawnedHand = Instantiate(handModelPrefab, transform);  // �׳� transform
